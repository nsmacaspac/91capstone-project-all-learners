...
"Out of the numerous new algorithmic contributions, I would like to highlight one - those humble baseline predictors (or biases), which capture main effects in the data. While the literature mostly concentrates on the more sophisticated algorithmic aspects, we have learned that an accurate treatment of main effects is probably at least as significant as coming up with modeling breakthroughs." (Koren 2009, 9)


"Other aspects of the data that may be integrated to improve prediction quality are content information like attributes of users or products, or dates associated with ratings, which may help to explain shifts in user preferences." (Koren 2008, 434)


[MovieLens 10M Dataset](https://grouplens.org/datasets/movielens/10m/) (Harper and Konstan 2015)


This project aims to use baseline estimates of the dataset to develop a recommendation system that predicts future user ratings with a root mean squared error rate of less than 0.86490.


To achieve this, we initially examine the user preferences using data visualization then subsequently build algorithms to develop the recommendation system.
...
## Recommendation System Based on Baseline Estimates 
