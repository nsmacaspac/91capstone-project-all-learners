...
The final algorithm and recommendation system was evaluated on the reserved 10% of the MovieLens 10M Dataset, the final holdout test set. This simulated the movie rating prediction of the recommendation system on future data and resulted in a decent RMSE of 0.86469 (tab. 1).
...
>As with the final algorithm, this project produced a recommendation system that predicts furture
